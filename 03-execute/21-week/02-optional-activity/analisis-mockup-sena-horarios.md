...
### H5 · Validaciones que muestran el error pero no bloquean el guardado

**Categoría:** Validación / UX · **Impacto:** 🔴 Alto

**Qué se observa**

Dos formularios muestran mensajes de error visibles pero el botón "Guardar" permanece activo:

1. **Modal de seguimiento:** asistentes = 21, total aprendices = 20 → mensaje: _"Los asistentes no pueden superar el total de aprendices"_ → botón activo.
2. **Modal de excepción de disponibilidad:** fecha fin (`2026-08-11`) anterior a fecha inicio (`2026-08-12`) → mensaje: _"La fecha de fin debe ser posterior al inicio"_ → botón activo.

Problema adicional: en el modal de seguimiento, el campo "Total de aprendices" es editable, permitiendo cambiar el denominador en cada registro. Ese valor debería venir del cupo de la ficha.

**Por qué importa**

El sistema detecta el error pero no lo previene. Un clic en "Guardar" enviaría un dato inválido al backend.

**Recomendación**

Cuando exista un error de validación activo, deshabilitar el botón de confirmación. El total de aprendices debe obtenerse del cupo registrado en la ficha y ser de solo lectura.

**Pantallas:** Registrar seguimiento (24), Modal crear excepción (22), Modal nuevo usuario (32)

---

### H6 · Sin aviso de tratamiento de datos personales
...
### H7 · Tablas en móvil con acciones múltiples que se amontonan
...
| H5 | Validaciones que no bloquean el guardado | Validación / UX | 🔴 Alto |
| H6 | Sin aviso de tratamiento de datos personales | Privacidad / Seguridad | 🔴 Alto |
| H7 | Acciones múltiples colisionadas en tablas móvil | Responsive / UI | 🟡 Medio |
